...
SPOTIPY_REDIRECT_URI = 'https://your-streamlit-app-url.streamlit.app'  # Replace with your Streamlit app URL
...
def main():
    ...
    with st.expander("📄 Privacy Policy"):
        ...
        **Data Collection:**
        - **Spotify Data:** This application accesses your Spotify account solely to create personalized playlists based on your preferences. The data accessed includes your public playlists, track information, and audio features.
        - **User Inputs:** Any additional information you provide (e.g., Genre, Mood, Energy Level) is used to tailor the playlist to your preferences.

        **Data Usage:**
        - The collected data is used to generate and manage your Spotify playlists.
        - No personal data is stored beyond the current session. Once you disconnect your Spotify account or end your session, all related data is cleared.

        **Data Sharing:**
        - Your data is not shared with any third parties. All processing is done within this application to provide you with a customized playlist experience.

        **Data Retention:**
        - The application does not retain any of your data after the session ends. All temporary data is cleared upon session termination or account disconnection.

        **User Rights:**
        - **Access:** You can view the data being used at any time during your session.
        - **Deletion:** You can disconnect your Spotify account at any time, which will immediately remove all associated data from the application.

        **Security:**
        - All data is transmitted securely using industry-standard encryption.
        - Sensitive information, such as access tokens and API keys, is stored securely using Streamlit's secrets management and is not exposed to the client-side.

        **Changes to Privacy Policy:**
        - This privacy policy may be updated from time to time. Any changes will be reflected within the application.

        **Contact Us:**
        - For any questions or concerns regarding this privacy policy, please contact us directly within the application.
...
def process_playlist_generation(
    ...
    try:
        ...
        with st.spinner('Creating new playlist...'):
            # Allow user to input a custom playlist name or use a default
